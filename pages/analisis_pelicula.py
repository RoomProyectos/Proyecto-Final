...
def main():    
    ...
    with col3:
        st.metric(label="Media de Palabras Masculinas", value=int(filtered_data["Male Mean Word Count"].values[0]))
        st.metric(label="Media de Palabras Femeninas", value=int(filtered_data["Female Mean Word Count"].values[0]))
